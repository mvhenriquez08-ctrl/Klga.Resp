...
const svt =
  "https://upload.wikimedia.org/wikipedia/commons/b/b5/Supraventricular-extrasystole-leadII.png";
const wpw =
...
const multifocalAtrialTachycardia =
  "https://upload.wikimedia.org/wikipedia/commons/e/e7/Multifocal_Atrial_Tachycardia_ECG.jpg";
const idioventricular =
  "https://upload.wikimedia.org/wikipedia/commons/f/f3/Accelerated_Idioventricular_Rhythm_AIVR.jpg";
const polymorphicVt =
  "https://upload.wikimedia.org/wikipedia/commons/c/c9/Polymorphic_VT.jpg";
const tvpcImg =
  "https://upload.wikimedia.org/wikipedia/commons/d/d6/Bidirectional_VT.jpg";
const atrialEctopicTachycardia =
  "https://upload.wikimedia.org/wikipedia/commons/e/e9/Atrial_Tachycardia.png";

const lbbb = "";
const rbbb = "";
const idioventricularImg = "";
const polymorphicVtImg = "";
const atrialEctopicTachycardiaImg = "";
...
export const categoryLabels: Record<ArrhythmiaCategory, string> = {
  ...
  preexcitacion: "Preexcitación", // Added label for 'preexcitacion'
  otros: "Otros",
};
...
export const arrhythmias: Arrhythmia[] = [
  ...
  },
  {
    ...
    category: "supraventricular", // Keep as supraventricular
    severity: "moderada",
    image: svt, // Updated image URL to the more representative one
    description:
  ...
  },
  {
    ...
    category: "bloqueo",
    severity: "benigna",
    image: firstDegreeAvb,
    description:
      "Prolongación del intervalo PR > 200 ms con conducción AV 1:1 preservada. No es un bloqueo verdadero.",
    ecgCriteria: [
      "PR > 200 ms (> 5 cuadraditos)",
      "Cada onda P seguida de QRS",
      "PR constante",
      "QRS estrecho (salvo bloqueo de rama concomitante)",
      "Ritmo regular",
    ],
    mechanism:
      "Retraso de la conducción a nivel del nodo AV, haz de His o sistema infranodal.",
    hemodynamicImpact:
      "Generalmente sin repercusión hemodinámica. PR muy largo (> 300 ms) puede causar síntomas tipo marcapasos.",
    icuContext:
      "Puede ser causado por fármacos (beta-bloqueantes, calcio-antagonistas, digoxina, amiodarona), isquemia inferior, miocarditis.",
    management: [
      "Observación en la mayoría de casos",
      "Revisar fármacos bradicardizantes",
      "Monitorización por posible progresión a BAV mayor",
    ],
    differentialDx: ["BAV de 2do grado tipo I", "Ritmo normal con PR límite"],
    keyFact:
      "Un PR > 300 ms puede causar 'síndrome de marcapasos' por disincronía AV, con disnea y fatiga.",
  },
  {
    id: "first-degree-avb",
    name: "Bloqueo AV de 1er Grado",
  ...
  {
    // Removed duplicate entry for 'first-degree-avb'
    id: "second-degree-type1",
    name: "BAV 2° Grado Tipo I (Wenckebach)",
    category: "bloqueo",
    severity: "moderada",
    image: secondDegreeType1,
    description:
      "Prolongación progresiva del PR hasta que un latido no se conduce. Patrón de 'agrupamiento' característico.",
    ecgCriteria: [
      "Prolongación progresiva del PR",
      "Acortamiento progresivo del RR",
      "P no conducida (QRS ausente) seguida de pausa",
      "Pausa < 2 intervalos RR consecutivos",
      "Patrón de agrupamiento (grouped beating)",
    ],
    mechanism:
      "Fatiga progresiva de la conducción en el nodo AV hasta el bloqueo completo transitorio de un impulso.",
    hemodynamicImpact:
      "Generalmente benigno. Puede causar síntomas si la frecuencia efectiva cae significativamente.",
    icuContext:
      "Frecuente en IAM inferior (irrigación del nodo AV por coronaria derecha). Suele ser transitorio. Puede ser inducido por digoxina.",
    management: [
      "Observación y monitorización",
      "Atropina si sintomático",
      "Suspender fármacos causantes",
      "Rara vez requiere marcapasos",
    ],
    differentialDx: [
      "BAV 2° grado tipo II",
      "BAV 1er grado",
      "Latidos bloqueados en FA",
    ],
    keyFact:
      "El Wenckebach en IAM inferior suele ser transitorio y benigno, resolviéndose en días sin necesidad de marcapasos.",
  },
  {
    // Removed duplicate entry for 'second-degree-type1'
    id: "second-degree-type2",
    name: "BAV 2° Grado Tipo II (Mobitz II)",
    category: "bloqueo",
    severity: "critica",
    image: secondDegreeType2,
    description:
      "Bloqueo intermitente de la conducción AV sin prolongación previa del PR. Alto riesgo de progresión a BAV completo.",
    ecgCriteria: [
      "PR constante en los latidos conducidos",
      "P bloqueada súbitamente sin prolongación previa del PR",
      "QRS frecuentemente ancho (bloqueo infranodal)",
      "Puede tener patrón fijo (2:1, 3:1) o intermitente",
      "Pausa = exactamente 2 intervalos PP",
    ],
    mechanism:
      "Bloqueo de la conducción a nivel infranodal (haz de His o ramas), indicando enfermedad del sistema de conducción.",
    hemodynamicImpact:
      "Alto riesgo de asistolia y muerte súbita por progresión a BAV completo. Ritmo de escape lento e inestable.",
    icuContext:
      "Asociado a IAM anterior extenso (necrosis septal), miocarditis, degeneración del sistema de conducción. Requiere marcapasos urgente.",
    management: [
      "Marcapasos transitorio urgente",
      "Marcapasos definitivo (indicación clase I)",
      "Atropina generalmente INEFICAZ (bloqueo infranodal)",
      "Isoproterenol como puente temporal",
      "Monitorización continua",
    ],
    differentialDx: [
      "BAV 2° grado tipo I",
      "BAV 2:1 (puede ser tipo I o II)",
      "BAV completo",
    ],
    keyFact:
      "A diferencia del tipo I, el Mobitz II requiere marcapasos definitivo. La atropina puede empeorar el bloqueo infranodal.",
  },
  {
    // Removed duplicate entry for 'second-degree-type2'
    id: "third-degree-avb",
    name: "BAV de 3er Grado (Completo)",
    category: "bloqueo",
    severity: "critica",
    image: thirdDegreeAvb,
    description:
      "Ausencia total de conducción AV. Aurículas y ventrículos laten independientemente (disociación AV completa).",
    ecgCriteria: [
      "Disociación AV completa (P y QRS independientes)",
      "Frecuencia auricular > frecuencia ventricular",
      "Intervalos PP regulares e intervalos RR regulares",
      "Sin relación entre P y QRS",
      "QRS estrecho (escape nodal) o ancho (escape ventricular)",
    ],
    mechanism:
      "Bloqueo completo de la conducción AV. Los ventrículos son rescatados por un foco de escape (nodal o ventricular).",
    hemodynamicImpact:
      "Frecuencia de escape 25-50 lpm. Bajo gasto cardíaco, hipotensión, síncope (crisis de Stokes-Adams). Riesgo de asistolia.",
    icuContext:
      "IAM inferior: escape nodal estable, puede resolver. IAM anterior: escape ventricular inestable, mal pronóstico. Puede ser causado por cirugía cardíaca.",
    management: [
      "Marcapasos transitorio urgente",
      "Atropina puede ser útil si escape nodal",
      "Isoproterenol o dopamina como puente",
      "Marcapasos definitivo si persistente",
      "Evaluar causas reversibles (fármacos, isquemia, miocarditis)",
    ],
    differentialDx: [
    ...
    keyFact:
      "Un BAV completo con QRS ancho y escape ventricular tiene alto riesgo de asistolia: marcapasos urgente sin excepción.",
  },
  {
    // Removed duplicate entry for 'third-degree-avb'
    id: "pvc",
  ...
  {
    // Removed duplicate entry for 'pvc'
    id: "junctional",
  ...
  {
    // Removed duplicate entry for 'junctional'
    id: "brugada",
  ...
  {
    // Removed duplicate entry for 'brugada'
    id: "long-qt",
  ...
  {
    // Removed duplicate entry for 'long-qt'
    id: "asystole",
    name: "Asistolia",
    category: "ventricular",
    severity: "critica",
  ...
  {
    // Removed duplicate entry for 'asystole'
    id: "pacemaker",
  ...
  {
    id: "multifocal-atrial-tachycardia", // Keep this one
    name: "Taquicardia Auricular Multifocal (TAM)",
    category: "supraventricular",
    severity: "moderada",
    image: multifocalAtrialTachycardia,
    description:
  ...
  },
  {
    ...
    escGuideline:
      "ESC 2022: En TV polimórfica sostenida/recurrente sin QT largo, buscar isquemia aguda (coronariografía urgente). Beta-bloqueantes IV como primera línea si sospecha de isquemia.", // Keep this
    references: [
  ...
  {
    id: "tvpc",
    name: "TV Polimórfica Catecolaminérgica (TVPC)", // Keep this one
    category: "canalopatia",
    severity: "critica",
    image: tvpcImg,
    description:
  ...
  },
  {
    ...
    category: "supraventricular",
    severity: "moderada",
    image: atrialEctopicTachycardiaImg,
    description:
    ...
    pharmacology:
      "La adenosina es útil como herramienta diagnóstica. Los beta-bloqueantes y calcio-antagonistas controlan la respuesta ventricular. La ablación con catéter tiene alta tasa de éxito en taquicardias focales.", // Keep this
