...
const harlequinSyndrome =
  "https://d2xsxph8kpxj0f.cloudfront.net/310519663463206971/QXZuwAxYMsqEZh9kyxLcbg/harlequin-syndrome_20ac9298.jpg"; // Specific image for Harlequin Syndrome
...
export const ecmoTopics: ECMOTopic[] = [
  ...
  // ===== COVID-19 =====
  {
    ...
    content: [
      ...
      "**Abordaje**: VV como primera línea. Se ha reportado afección miocárdica directa (miocarditis, eventos coronarios) — considerar introductor arterial femoral para potencial conversión a VA o VAV.",
    ],
    keyPoints: [
